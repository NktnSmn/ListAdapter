...
import com.nktnsmn.listadapter.items.AdapterItemsWithAsyncDiffer
...
class DefaultCellularListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BindableViewHolder =
        itemViewCells.getForViewType(viewType).let { itemViewCell ->
            BindableViewHolder(itemViewCell.createBinding(parent), itemViewCell.cellBindingVariables)
        }
}